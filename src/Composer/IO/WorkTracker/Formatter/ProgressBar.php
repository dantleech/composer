...
class ProgressBar {
    ...
    /**
     * Displays the progress bar without overwriting previous output.
     */
    public function displayFromStart()
    {
        if (null === $this->format) {
            $this->setRealFormat($this->internalFormat ?: $this->determineBestFormat());
        }
        ...
        if($this->overwrite) {
            // move the current cursor to the end of the area before overwriting
